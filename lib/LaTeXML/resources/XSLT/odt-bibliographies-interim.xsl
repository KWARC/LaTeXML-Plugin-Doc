...
<xsl:stylesheet xmlns:ltx="http://dlmf.nist.gov/LaTeXML" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:b="http://schemas.openxmlformats.org/officeDocument/2006/bibliography" xmlns:exsl="http://exslt.org/common" version="1.0" exclude-result-prefixes="ltx">
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>techreport</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>unpublished</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>manual</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>incollection</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>booklet</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>inbook</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
  ...
  <xsl:if test="$document//ltx:bibitem[@key=$foo]">
    <b:Source>
      <b:SourceType>article</b:SourceType>
      <b:Tag>
        <xsl:value-of select="./@key"/>
      </b:Tag>
      <b:Author>
