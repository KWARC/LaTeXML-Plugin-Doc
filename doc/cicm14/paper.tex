...
\begin{abstract}
  ...
  transformed structures can be edited and processed further.\ednote{Mir ist die Trennung
    zwischen theoretisch und praktisch nicht ganz so recht, angewandte mathematiker
    bzw. Physiker benutzen doch auch Latex? }
\end{abstract}
...
%  LocalWords:  paper.ltxml group.ltxml ltmxl ltxml stex CPoint CWord ist Trennung und
